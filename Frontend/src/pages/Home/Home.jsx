        ...
        <div className="lg:w-[50%] border-r">
          <div className="p-3 flex items-center gap-4 ">
            <Button
              ...
              className="rounded-full px-10 bg-[#ffffff] border hover:border-0 hover:bg-[#38b6ff] hover:bg-opacity-85 text-xl"
            >
              All
            </Button>
            <Button
              ...
              className="rounded-full border hover:border-0 px-10 bg-[#ffffff] hover:bg-[#38b6ff] hover:bg-opacity-85 text-xl"
            >
              Top 50
            </Button>
