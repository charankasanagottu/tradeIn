            ...
            <div className="lg:flex gap-32">
              ...
              <div className="space-y-7">
                <div className="flex">
                  ...
                  <p className="">{"478 Lindbergh PL NE"} </p>
                </div>
                <div className="flex">
        ...
        <Card className="w-full">
            ...
            <CardContent className="space-y-5">
              ...
              <div>
                <Dialog>
                  <DialogTrigger>
                    <Button className="hover:bg-[#38b6ff] hover:bg-opacity-60">Enabled Two Step Verification</Button>
                  </DialogTrigger>
                  <DialogContent className="bg-[#ffffff] text-black text-xl">
          ...
          <Card className="w-full">
            ...
            <CardContent className="space-y-5">
              ...
              <div>
                <Dialog>
                  <DialogTrigger>
                    <Button className="hover:bg-[#38b6ff] hover:bg-opacity-60">Verify Account</Button>
