        ...
        <div className="flex justify-between items-center">
          ...
          <Dialog>
            ...
            <Button
              ...
              }className="hover:bg-[#38b6ff] rounded-3xl border hover:border-0"
              >
                Sent OTP
              </Button>
            ...
            <DialogContent className="bg-[#ffffff] text-black">
              ...
              <div className="py-5 flex gap-10 justify-center items-center">
                ...
                <DialogClose>
                  <Button onClick={()=>handleSubmit(value)} className="w-[10rem] rounded-3xl hover:bg-[#38b6ff]">Submit</Button>
                </DialogClose>
