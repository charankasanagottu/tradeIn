...
import { DollarSign, IndianRupee, WalletIcon } from "lucide-react";
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="flex gap-7 mt-5">
              <Dialog className="">
                <DialogTrigger>
                  <div className="h-24 w-24 hover:text-gray-400 cursor-pointer flex flex-col items-center justify-center rounded-3xl shadow-slate-800 shadow-md ">
                    <UploadIcon />
